...
* This is why watermarks are actively surfaced by `dieharder` and rejected **only when** they introduce apparent predictability through test-induced circularity, rather than merely indicating provenance.
