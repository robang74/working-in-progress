...
* **uChaos vs Thermodynamics**: 1. [presentation](uchaos-vs-thermodynamics.md), &nbsp; 2. release [v0.3.1](https://github.com/robang74/working-in-progress/releases/tag/uchaos-v0.3.1) as reference for uChaos testing
...
* **uChaos testing in 0°K VM** in: 1. [blms-v0.2.5](https://github.com/robang74/bare-minimal-linux-system/releases/tag/bmls-v0.2.5), &nbsp; 2. run `sh start.sh -Z` or `-z` for manual
