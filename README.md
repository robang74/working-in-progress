...
* **uChaos static x86 elf32** available: 1. [prpr/bin](prpr/bin) folder, &nbsp; 2. self-ungzip executable by [gzcmd.sh](https://github.com/robang74/bare-minimal-linux-system/blob/main/gzcmd.sh) (old ver.)
* **uChaos vs PractRnd** documentation: 1. [presentation](https://github.com/robang74/working-in-progress/blob/main/uchaos-vs-kernel-ring.md), &nbsp; 2. [datalogs](https://github.com/robang74/working-in-progress/raw/refs/heads/main/data/uchaos-256GB-test.log.gz) of 256GB test passed
